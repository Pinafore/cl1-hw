...
.\tPU\t3"""
    ...
    def test_oracle(self):
        ...
        self.assertEqual(transitions[1]._type, 's')
        self.assertEqual(transitions[2]._type, 'l')
        self.assertEqual(transitions[2]._edge, (2, 1))
        self.assertEqual(transitions[3]._type, 's')
        self.assertEqual(transitions[4]._type, 'l')
        self.assertEqual(transitions[4]._edge, (3, 2))        
        self.assertEqual(transitions[5]._type, 's')                                
        self.assertEqual(transitions[6]._type, 's')                                
        self.assertEqual(transitions[7]._type, 'l')
        self.assertEqual(transitions[7]._edge, (5, 4))        
        self.assertEqual(transitions[8]._type, 's')
        self.assertEqual(transitions[9]._type, 's')
        self.assertEqual(transitions[10]._type, 's')
        self.assertEqual(transitions[11]._type, 'l')
        self.assertEqual(transitions[11]._edge, (8, 7))                
        self.assertEqual(transitions[12]._type, 'r')
        self.assertEqual(transitions[12]._edge, (6, 8))                        
        self.assertEqual(transitions[13]._type, 'r')
        self.assertEqual(transitions[13]._edge, (5, 6))                                
        self.assertEqual(transitions[14]._type, 'r')
        self.assertEqual(transitions[14]._edge, (3, 5))                                        
        self.assertEqual(transitions[15]._type, 's')
        self.assertEqual(transitions[16]._type, 'r')
        self.assertEqual(transitions[16]._edge, (3, 9))                                                
        self.assertEqual(transitions[17]._type, 'r')
        self.assertEqual(transitions[17]._edge, (0, 3))                                                
